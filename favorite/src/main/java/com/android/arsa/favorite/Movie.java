...
import static com.android.arsa.favorite.DatabaseContract.ColumnMovie.COLUMNS_POSTER_PATH;
import static com.android.arsa.favorite.DatabaseContract.ColumnMovie.COLUMNS_RELEASE_DATE;
import static com.android.arsa.favorite.DatabaseContract.ColumnMovie.COLUMNS_TITLE;
import static com.android.arsa.favorite.DatabaseContract.ColumnMovie.COLUMNS_VOTE_AVERAGE;
import static com.android.arsa.favorite.DatabaseContract.getColumnInt;
...
//            String popular = new DecimalFormat("#.#").format(popularity);
            ...
            String dateFormat = new SimpleDateFormat("EEEE, dd MM yyyy").format(date);
